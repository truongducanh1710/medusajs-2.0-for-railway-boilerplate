export const PERMISSIONS = {
  ...
  "page.agent-video.view": "Xem Agent Video — ROAS từng video, nhật ký quyết định",
  "page.agent-video.manage": "Cấp/thu hồi hạn mức ngân sách cho Agent Video, khoá video",

...
function AcheckinPage() {
  ...
  const [section, setSection] = useState<"cham-cong" | "xin-nghi">("cham-cong")

  return (
    <div className="mx-auto max-w-2xl p-6">
      <h1 className="mb-1 text-xl font-semibold">Acheckin</h1>
      <p className="mb-4 text-sm text-gray-500">Chấm công vị trí + báo nghỉ</p>
      ...
      {section === "cham-cong" ? <ChamCongSection /> : <XinNghiSection canApprove={canApprove} />}
    </div>
  )
}

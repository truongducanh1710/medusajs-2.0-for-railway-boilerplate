...
2. **Phân tích từng cảnh** — tách cảnh theo tiêu chí: (a) góc quay thay đổi, (b) chủ thể/hành động chuyển sang ý mới, (c) cut/transition rõ ràng. KHÔNG gom nhiều ý vào 1 cảnh. Ghi timestamp chính xác theo thực tế video.

...
export default defineMiddlewares({
  routes: [
    ...
    { matcher: "/admin/product-tests/campaign-metrics", method: ["GET"], middlewares: [requirePerm("page.product-test.view")] },
    ...
    { matcher: "/admin/ai-agents*", method: ["GET"], middlewares: [requirePerm("page.ai-settings.manage")] },
    ...
    { matcher: "/admin/fb-content/boost/activity*", method: ["GET"], middlewares: [requirePerm("page.fb-content.boost")] },
